        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <a href="delete_product.php?id=<?php echo $row['id']; ?>" style=""> <input type="button" id="delete" class="btn btn-primary rounded-pill py-2 btn-block" style="background-color: red;color: white;margin:0px  10px;" value="Delete"></a></td>
